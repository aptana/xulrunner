...
//@line 41 "/builds/moz2_slave/xulrunner_macosx_build/build/xulrunner/setup/nsXULAppInstall.js"
...
const AppInstall = {
  ...
  installApplication : function ai_IA(aAppFile, aDirectory, aLeafName) {
    ...
    if (aDirectory == null) {
//@line 240 "/builds/moz2_slave/xulrunner_macosx_build/build/xulrunner/setup/nsXULAppInstall.js"
      aDirectory = getDirectoryKey("LocApp");
      if (vendor)
        aDirectory.append(vendor);
//@line 251 "/builds/moz2_slave/xulrunner_macosx_build/build/xulrunner/setup/nsXULAppInstall.js"
    }
    else {
    ...
    if (aLeafName == "") {
//@line 262 "/builds/moz2_slave/xulrunner_macosx_build/build/xulrunner/setup/nsXULAppInstall.js"
      aLeafName = appName + ".app";
//@line 270 "/builds/moz2_slave/xulrunner_macosx_build/build/xulrunner/setup/nsXULAppInstall.js"
    }
...
//@line 278 "/builds/moz2_slave/xulrunner_macosx_build/build/xulrunner/setup/nsXULAppInstall.js"
...
//@line 348 "/builds/moz2_slave/xulrunner_macosx_build/build/xulrunner/setup/nsXULAppInstall.js"
  }
};
